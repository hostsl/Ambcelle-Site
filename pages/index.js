...
export default function Home() {
    return (
        <div>
            {/* Try to use the nav element to create a responsive navbar. Use flowbite navbar
                it has responsive characteristics. Make sure you activate the collaspe button. */}
            <div className={"w-full bg-white h-[126px]"}>
                <div className={"float-left ml-[50px] mt-[10px]"}>
                <a href="#" class="flex items-center">
                    <img className={"mr-3 lg:h-24 h-20 mt-4 lg:mt-1"} src="/assets/Ambhelle-logo 1.png" alt="service1" />
                </a>
                </div>
                <div className={"float-right mr-[50px]  mt-[40px]"}>
                    <a href="#"
                        className="focus:outline-none text-black bg-white hover:bg-yellow-500 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2">Home
                    </a>

                    <a href="#"
                        className="focus:outline-none text-black bg-white hover:bg-yellow-500 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2">Job
                    </a>

                    <button type="button"
                        className="focus:outline-none text-black bg-yellow-400 hover:bg-yellow-500 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2">LOGIN
                    </button>
                ...
                <div className={"h-full"}>
                    ...
                    <div className={"flex flex-col bg-[#1AB8C0] h-[530px] pl-[100px] mt-[40px]"}>
                        ...
                        <div className={"mt-[20px] items-center"}>
                            ...
                            <span className={"leading-[27.84px] font-bold text-[27px] ml-[20px]"}>+2327777777 / +232888888</span>
                        </div>
                        ...
                        <div className={"mt-[20px]"}>
                            ...
                            <span className={"ml-[52px]"}>Branch</span> </span> 
                        </div>
                    </div>
                </div>
            </div>

            <div className={"w-full bg-black flex h-[151px] items-center grid grid-cols-2 lg:grid-row-2"}>
                <div className={"flex-col items-center text-white ml-20"}>
                    <h1 className={"leading-[32.68px] font-bold text-[27px]"}>Ambchelle Foreign Exchange Bureau</h1>
                    <h3 className={"leading-[24.2px] font-normal text-[20px]"}>&#169; 2022</h3>
                </div>
